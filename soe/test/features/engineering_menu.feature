Feature: Stanford School of Engineering Menus
  ...
  Scenario: Verify that we have the correct Students & Academics navigation items
    ...
    When I click "About"
    Then I should be on "students-academics/global-engineering-programs/about"
    ...
    When I click "CS Pathfinders"
    Then I should be on "students-academics/engineering-diversity-programs/cs-pathfinders"
